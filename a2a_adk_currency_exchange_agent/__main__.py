...
from agent import root_agent as currency_exchange_agent
...
async def main(host, port):
    agent_card = AgentCard(
        name=currency_exchange_agent.name,
        description=currency_exchange_agent.description,
        version='1.0.0',
        ...
        skills=[
            AgentSkill(
                ...
                description='Returns information about currency exchange rates.',
                tags=['currency', 'exchange', 'rates', 'conversion'],
                examples=[
                    'How many Euros is it to the Dollar?',
                    'What is 50 USD in GBP?',
                    'What is $1000 in Yen?'
                ]
            )
        ],
